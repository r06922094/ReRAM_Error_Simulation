...
with tf.name_scope('Conv1'):
    ...
    h_conv1_o = tf.nn.conv2d(x_image, W_conv1, strides=[1,1,1,1], padding='SAME', name='convolution') + b_conv1
...
print(sess.run(h_conv1_o, feed_dict={x:test_img[0:2], y_:test_label[0:2]}))
print(sess.run(h_conv1, feed_dict={x:test_img[0:2], y_:test_label[0:2]}))
